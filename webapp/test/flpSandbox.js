					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ulis Northwind App",
									"targetURL": "#mynorthwind-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"mynorthwind-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mynorthwind",
									"url": sap.ui.require.toUrl("mynorthwind")
								}
							}
						}
					}
